...
### Fixed
- Removed transparency from "Ask Me Anything" panel - now solid white background
- Removed transparency from Settings panel - now solid white background
- Increased panel width from 320px/360px to 380px/420px for better text display
- Removed backdrop-blur effects that caused see-through appearance
- Improved Hindi text display with wider layout

### Changed
- Panel backgrounds now use solid `bg-background` instead of semi-transparent `bg-background/95`
- Better visual hierarchy with solid panels and gradient accents
